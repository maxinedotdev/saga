...
export interface MigrationResultV1 {
    ...
    /** Number of code blocks migrated */
    codeBlocksMigrated: number;
    /** Number of tags migrated */
    tagsMigrated: number;
    /** Number of languages migrated */
    languagesMigrated: number;
...
export interface MigrationOptions {
    ...
    /** Dry run without actual changes */
    dryRun?: boolean;
    /** Create vector indexes after migration */
 ...
 */
export interface MigrationScriptV1 {
    /** Schema version */
    version: string;
    /** Migration description */
    description: string;
